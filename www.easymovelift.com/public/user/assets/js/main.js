...
// // popup custom code start
// $('.image-link').click(function(){
//   $(".mfp-zoom-out-cur .mfp-s-ready .mfp-figure figure").remove();
//   $(".mfp-zoom-out-cur .mfp-s-ready .mfp-figure").append(`<video autoplay="" controls>
//   <source src="" type="video/mp4">
// </video>
// `)
  
// $(".mfp-zoom-out-cur .mfp-s-ready .mfp-figure video source").attr('src', $(".work-wrapper .image-link").attr("video-link"))
// });
// // popup custom code end
